...
class ActionMailbox::Ingresses::Mailgun::RequestParserTest < ActiveSupport::TestCase
  ...
  test "Mailgun request parser is installed in the middleware stack" do
    ...
    assert_not_nil mailgun_parser
    assert_equal({ bytesize_limit: 25.megabytes }, mailgun_parser.kwargs)
  end
