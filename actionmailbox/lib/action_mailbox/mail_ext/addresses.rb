...
module Mail
  class Message
    ...
    def recipients_addresses
      to_addresses + cc_addresses + bcc_addresses + x_original_to_addresses + delivered_to_addresses
    end
    ...
    def delivered_to_addresses
      Array(header[:delivered_to]).collect { |header| Mail::Address.new header.to_s }
    end
  end
end
