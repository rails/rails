...
module ActionView
  class AssetPaths #:nodoc:
    ...
    def compute_public_path(source, dir, options = {})
      ...
      source = rewrite_extension(source, dir, options[:ext]) if should_rewrite_extension?(source, options)
    ...
    def should_rewrite_extension?(source, options)
      options[:ext] && (source =~ Regexp.new(".#{options[:ext]}")).nil?
    end
