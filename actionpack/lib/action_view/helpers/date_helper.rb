...
module ActionView
  module Helpers
    ...
    module DateHelper
      ...
      # To display months with a leading zero AND use month names, set the <tt>:add_month_numbers_two_digits</tt> 
      ...
      #   select_month(Date.today, add_month_numbers_two_digits: true)
      #
      #   # Generates a select field for months that defaults to the current month that
    ...
    class DateTimeSelector #:nodoc:
      ...
      private
        ...
        #
        # If <tt>:add_month_numbers_two_digits</tt> option is passed
