...
module ActionController
  ...
  class TestCase < ActiveSupport::TestCase
    module Behavior
      ...
      #
      # - +action+: The controller action to call.
      # - +http_method+: request method used to send http request. possible values GET, POST, HEAD, PUT, DELETE, PATCH. defaults to GET.
      ...
      #
      # To simulate +GET+, +POST+, +PATCH+, +PUT+, +DELETE+ and +HEAD+ requests prefer using #get, #post, #patch, #put, #delete, and #head respectively which will make your tests more expressive.
      #
