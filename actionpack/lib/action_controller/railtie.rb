...
module ActionController
  class Railtie < Rails::Railtie # :nodoc:
    ...
    initializer "action_controller.freeze_configuration" do |app|
      config.after_initialize do
        if app.config.freeze_configuration
          ActiveSupport::Ractors.make_shareable(ActionController::Parameters.always_permitted_parameters)

          ActiveSupport.on_load(:action_controller_live) do
            ActiveSupport::Ractors.make_shareable(ActionController::Live.live_streaming_excluded_keys)
          end
        end
      end
    end
