  ...
  module Testing
    ...
    class TestCollector < ActiveSupport::TestCase
      ...
      test "generated methods call custom with arguments received" do
        ...
        assert_equal [ActiveSupport::Mime[:html], [], nil], collector.responses[0]
        assert_equal [ActiveSupport::Mime[:text], [:foo], nil], collector.responses[1]
        assert_equal [ActiveSupport::Mime[:js], [:bar]], collector.responses[2][0,2]
