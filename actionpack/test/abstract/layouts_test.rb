...
module AbstractControllerTests
  module Layouts
    ...
    class WithProcEvalingInContextOfInstance < Base
      def an_instance_method; end

      layout proc {
        break nil unless respond_to? :an_instance_method
        "overwrite"
      }
    ...
    class TestBase < ActiveSupport::TestCase
      ...
      test "when layout is specified as a proc without parameters the block is evaled in the context of an instance" do
        controller = WithProcEvalingInContextOfInstance.new
        controller.process(:index)
