...
class AssetTagHelperTest < ActionView::TestCase
  ...
  JavascriptIncludeToTag = {
    ...
    %(javascript_include_tag("bank", :params => {:deposit => "5000"})) => %(<script src="/javascripts/bank.js?deposit=5000" type="text/javascript"></script>),
    %(javascript_include_tag("bank?deposit=5000")) => %(<script src="/javascripts/bank.js?deposit=5000" type="text/javascript"></script>),
  ...
  StyleLinkToTag = {
    ...
    %(stylesheet_link_tag("bank", :params => {:deposit => 5000})) => %(<link href="/stylesheets/bank.css?deposit=5000" media="screen" rel="stylesheet" type="text/css" />),
    %(stylesheet_link_tag("bank?deposit=5000")) => %(<link href="/stylesheets/bank.css?deposit=5000" media="screen" rel="stylesheet" type="text/css" />),
