...
class DateHelperTest < ActionView::TestCase
  ...
  def test_select_month_with_two_digit_numbers_and_names
    ...
    assert_dom_equal expected, select_month(Time.mktime(2003, 8, 16), :add_month_numbers_two_digits => true)
    assert_dom_equal expected, select_month(8, :add_month_numbers_two_digits => true)
  end
