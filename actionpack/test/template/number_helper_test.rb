...
class NumberHelperTest < ActionView::TestCase
  ...
  def test_number_helpers_outputs_are_html_safe
    ...
    refute number_to_human("<script></script>").html_safe?
    ...
    refute number_to_human_size("<script></script>").html_safe?
    ...
    refute number_with_precision("<script></script>").html_safe?
    ...
    refute number_to_currency("<script></script>").html_safe?
    ...
    refute number_to_percentage("<script></script>").html_safe?
    ...
    refute number_with_delimiter("<script></script>").html_safe?
