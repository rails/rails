...
class TextHelperTest < ActionView::TestCase
  ...
  def test_pluralization
    ...
    assert_equal("1 count", pluralize('1', "count"))
    assert_equal("2 counts", pluralize('2', "count"))
    assert_equal("counts", pluralize('2', "count", nil, true))
    assert_equal("2 counts", pluralize('2', "count", nil, false))
    ...
    assert_equal("counters", pluralize(nil, "count", "counters", true))
