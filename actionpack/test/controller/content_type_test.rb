...
class OldContentTypeController < ActionController::Base
  ...
  def render_change_for_builder
    response.content_type = ActiveSupport::Mime[:html]
  ...
  def render_default_content_types_for_respond_to
    respond_to do |format|
      ...
      format.rss  { render body: "hello world!", content_type: ActiveSupport::Mime[:xml] }
    end
  end
end
...
class ContentTypeTest < ActionController::TestCase
  ...
  def test_render_defaults
    ...
    assert_equal ActiveSupport::Mime[:text], @response.content_type
  end
  ...
  def test_content_type_from_body
    ...
    assert_equal ActiveSupport::Mime[:rss], @response.content_type
    assert_equal "utf-8", @response.charset
  end
  ...
  def test_nil_default_for_erb
    with_default_charset nil do
      ...
      assert_equal ActiveSupport::Mime[:html], @response.content_type
...
class AcceptBasedContentTypeTest < ActionController::TestCase
  ...
  def test_render_default_content_types_for_respond_to
    @request.accept = ActiveSupport::Mime[:html].to_s
    get :render_default_content_types_for_respond_to
    assert_equal ActiveSupport::Mime[:html], @response.content_type

    @request.accept = ActiveSupport::Mime[:js].to_s
    get :render_default_content_types_for_respond_to
    assert_equal ActiveSupport::Mime[:js], @response.content_type
  end

  def test_render_default_content_types_for_respond_to_with_template
    @request.accept = ActiveSupport::Mime[:xml].to_s
    get :render_default_content_types_for_respond_to
    assert_equal ActiveSupport::Mime[:xml], @response.content_type
  end

  def test_render_default_content_types_for_respond_to_with_overwrite
    @request.accept = ActiveSupport::Mime[:rss].to_s
    get :render_default_content_types_for_respond_to
    assert_equal ActiveSupport::Mime[:xml], @response.content_type
  end
end
