...
class RackMountIntegrationTests < ActiveSupport::TestCase
  ...
  def test_unicode_path
    assert_equal({ controller: "news", action: "index" }, @routes.recognize_path(URI::RFC2396_Parser.new.escape("こんにちは/世界"), method: :get))
  end

  def test_downcased_unicode_path
    assert_equal({ controller: "news", action: "index" }, @routes.recognize_path(URI::RFC2396_Parser.new.escape("こんにちは/世界").downcase, method: :get))
  end
