...
class RateLimitedController < ActionController::Base
  ...
  rate_limit to: 2.times, within: 2.seconds, only: :limited_with_enumerator
  def limited_with_enumerator
    head :ok
  end
...
class RateLimitingTest < ActionController::TestCase
  ...
  test "limited with Enumerator" do
    get :limited_with_enumerator
    get :limited_with_enumerator
    assert_response :ok
