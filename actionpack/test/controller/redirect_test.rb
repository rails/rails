...
class RedirectController < ActionController::Base
  ...
  def redirect_to_relative_url_without_leading_slash
    redirect_to "example.com"
  end

  def redirect_to_relative_url_starting_with_an_at
    redirect_to "@example.com"
  end
...
class RedirectTest < ActionController::TestCase
  ...
  def test_redirect_to_url_with_relative_url_without_leading_slash
    get :redirect_to_relative_url_without_leading_slash
    assert_response :redirect
    assert_equal "http://test.hostexample.com", redirect_to_url
  end

  def test_redirect_to_url_with_relative_url_starting_with_an_at
    get :redirect_to_relative_url_starting_with_an_at
    assert_response :redirect
  ...
  def test_redirect_to_relative_url_without_leading_slash_with_log
    old_config = ActionController::Base.action_on_relative_redirects_without_leading_slash
    ActionController::Base.action_on_relative_redirects_without_leading_slash = :log
    ...
    assert_response :redirect
    assert_equal "http://test.hostexample.com", redirect_to_url
    assert_match(/Relative URL redirect without leading slash detected: "example.com"/, logger.logged(:warn).last)
  ensure
    ActionController::Base.logger = old_logger
    ActionController::Base.action_on_relative_redirects_without_leading_slash = old_config
  end

  def test_redirect_to_relative_url_starting_with_an_at_with_log
    old_config = ActionController::Base.action_on_relative_redirects_without_leading_slash
    ActionController::Base.action_on_relative_redirects_without_leading_slash = :log
  ...
  def test_redirect_to_relative_url_starting_with_an_at_with_notify
    old_config = ActionController::Base.action_on_relative_redirects_without_leading_slash
    ActionController::Base.action_on_relative_redirects_without_leading_slash = :notify
    ...
    assert_equal 'Relative URL redirect without leading slash detected: "@example.com"', event.payload[:message]
    assert_kind_of Array, event.payload[:stack_trace]
    assert event.payload[:stack_trace].any? { |line| line.include?("redirect_to_relative_url_starting_with_an_at") }
  ensure
    ActiveSupport::Notifications.unsubscribe("unsafe_redirect.action_controller")
    ActionController::Base.action_on_relative_redirects_without_leading_slash = old_config
  end

  def test_redirect_to_relative_url_without_leading_slash_with_notify
    old_config = ActionController::Base.action_on_relative_redirects_without_leading_slash
    ActionController::Base.action_on_relative_redirects_without_leading_slash = :notify
    ...
    assert_equal 'Relative URL redirect without leading slash detected: "example.com"', event.payload[:message]
    assert_kind_of Array, event.payload[:stack_trace]
    assert event.payload[:stack_trace].any? { |line| line.include?("redirect_to_relative_url_without_leading_slash") }
  ensure
    ActiveSupport::Notifications.unsubscribe("unsafe_redirect.action_controller")
    ActionController::Base.action_on_relative_redirects_without_leading_slash = old_config
  end

  def test_redirect_to_relative_url_without_leading_slash_with_raise
    old_config = ActionController::Base.action_on_relative_redirects_without_leading_slash
    ActionController::Base.action_on_relative_redirects_without_leading_slash = :raise

    error = assert_raise(ActionController::Redirecting::UnsafeRedirectError) do
      get :redirect_to_relative_url_without_leading_slash
    end

    assert_equal 'Relative URL redirect without leading slash detected: "example.com"', error.message
  ensure
    ActionController::Base.action_on_relative_redirects_without_leading_slash = old_config
  end

  def test_redirect_to_relative_url_starting_with_an_at_with_raise
    old_config = ActionController::Base.action_on_relative_redirects_without_leading_slash
    ActionController::Base.action_on_relative_redirects_without_leading_slash = :raise
