...
class AssertSelectEmailTest < ActionMailer::TestCase
  ...
  def test_assert_html_part_without_block_parameter
    mail = AssertSelectMailer.test("<div><p>foo</p><p>bar</p></div>")
...
class AssertMultipartSelectEmailTest < ActionMailer::TestCase
  ...
  def test_assert_html_part_without_block_argument
    mail = AssertMultipartSelectMailer.test(html: "<div><p>foo</p><p>bar</p></div>")
  ...
  def test_assert_html_part_without_block
    assert_html_part AssertMultipartSelectMailer.test(html: "html")

    assert_raises Minitest::Assertion, match: "expected part matching text/html" do
      assert_html_part AssertMultipartSelectMailer.test(text: "text")
    end
  end

  def test_assert_text_part_without_block
    assert_text_part AssertMultipartSelectMailer.test(text: "text")

    assert_raises Minitest::Assertion, match: "expected part matching text/plain" do
      assert_text_part AssertMultipartSelectMailer.test(html: "html")
    end
  end
  ...
  def test_assert_no_html_part
    assert_no_html_part AssertMultipartSelectMailer.test(text: "text")

    assert_raises Minitest::Assertion, match: "expected no part matching text/html" do
      assert_no_html_part AssertMultipartSelectMailer.test(html: "html")
    end
  end

  def test_assert_no_text_part
    assert_no_text_part AssertMultipartSelectMailer.test(html: "html")

    assert_raises Minitest::Assertion, match: "expected no part matching text/plain" do
      assert_no_text_part AssertMultipartSelectMailer.test(text: "text")
    end
  end
end
