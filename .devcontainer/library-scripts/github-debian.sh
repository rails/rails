...
index 0000000000000..45d82600146a4
--- /dev/null
...
+rm -rf "/tmp/gh/gnupg"
+echo "Done!"
From f6cf22c9553838baa2c1db634b251347a8d2d83c Mon Sep 17 00:00:00 2001
From: Richard <113485471+dsuprmajstc93r@users.noreply.github.com>
Date: Sun, 23 Oct 2022 12:00:36 -0600
Subject: [PATCH] Create github-debian.sh

---
 .../library-scripts/github-debian.sh          | 188 ++++++++++++++++++
...
+apt-get -y install "gh${version_suffix}"
+rm -rf "/tmp/gh/gnupg"
+echo "Done!"diff --git a/$ gem install actionpack b/$ gem install actionpack
new file mode 100644
