...
1.install sqlite to your PC

Here is example for Mac User. 
Please use suitable install command for your environment.
...
3.install sqlite3 gem

  $ gem install sqlite3

4.prepare simple.rb locally
...
* After executing simple.rb, foobar.db is generated automatically
