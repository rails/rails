...
module ActiveRecord
  class InvertibleMigrationTest < ActiveRecord::TestCase
    ...
    def test_migrate_down
      ...
      migration.migrate :up
      migration.migrate :down
      refute migration.connection.table_exists?("horses")
    end
    ...
    def test_legacy_down
      ...
      refute ActiveRecord::Base.connection.table_exists?("horses"), "horses should not exist"
    end
    ...
    def test_migrate_down_with_table_name_prefix
      ...
      refute ActiveRecord::Base.connection.table_exists?("p_horses_s"), "p_horses_s should not exist"
    ensure
