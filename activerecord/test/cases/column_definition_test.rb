    ...
    class ColumnDefinitionTest < ActiveRecord::TestCase
      ...
      if current_adapter?(:MysqlAdapter)
        ...
        def test_should_not_set_default_for_blob_and_text_data_types
          assert_raise ArgumentError do
            MysqlAdapter::Column.new("title", "a", Type::Text.new, "blob")
          end

          assert_raise ArgumentError do
            MysqlAdapter::Column.new("title", "Hello", Type::Text.new, "text")
          end

          text_column = MysqlAdapter::Column.new("title", nil, Type::Text.new, "text")
        ...
        def test_has_default_should_return_false_for_blob_and_text_data_types
          blob_column = MysqlAdapter::Column.new("title", nil, Type::Text.new, "blob")
      ...
      if current_adapter?(:Mysql2Adapter)
        ...
        def test_should_not_set_default_for_blob_and_text_data_types
          ...
          assert_raise ArgumentError do
            Mysql2Adapter::Column.new("title", "Hello", Type::Text.new, "text")
          end

          text_column = Mysql2Adapter::Column.new("title", nil, Type::Text.new, "text")
          assert_equal nil, text_column.default
