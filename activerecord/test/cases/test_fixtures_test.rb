  ...
  unless in_memory_db?
    ...
    def test_transactional_tests_per_db_explicitly_disabled
      ...
      klass = Class.new(Minitest::Test) do
        ...
        self.fixture_paths = [tmp_dir]
        self.use_transactional_tests = true
        self.set_database_transactions(:primary, false)
    ...
    def test_transactional_tests_per_db_explicitly_enabled
      ...
      klass = Class.new(Minitest::Test) do
        ...
        self.fixture_paths = [tmp_dir]
        self.use_transactional_tests = false
        self.set_database_transactions(:primary, true)
    ...
    def test_transactional_tests_per_db_explicitly_default
      tmp_dir = Dir.mktmpdir
      File.write(File.join(tmp_dir, "zines.yml"), <<~YML)
      going_out:
        title: Hello
      ...
      klass = Class.new(Minitest::Test) do
        ...
        self.use_transactional_tests = true
        self.set_database_transactions(:primary, false)
        self.set_database_transactions(:primary, nil)
    ...
    def test_transactional_tests_per_db_default_enabled
      ...
      klass = Class.new(Minitest::Test) do
        ...
        self.fixture_paths = [tmp_dir]
        self.use_transactional_tests = true
        self.set_database_transactions(:unrelated, false)
    ...
    def test_transactional_tests_per_db_default_disabled
      ...
      klass = Class.new(Minitest::Test) do
        ...
        self.fixture_paths = [tmp_dir]
        self.use_transactional_tests = false
        self.set_database_transactions(:unrelated, true)
