...
class TestFixturesTest < ActiveRecord::TestCase
  ...
  unless in_memory_db?
    ...
    def test_disable_transactional_tests_per_db
      tmp_dir = Dir.mktmpdir
      File.write(File.join(tmp_dir, "zines.yml"), <<~YML)
      going_out:
        title: Hello
      ...
      klass = Class.new(Minitest::Test) do
        ...
        self.fixture_paths = [tmp_dir]
        self.use_transactional_tests = true
        self.ignore_transactions_dbnames = [:primary]
    ...
    def test_disable_transactional_tests_per_db_default_enabled
      tmp_dir = Dir.mktmpdir
      File.write(File.join(tmp_dir, "zines.yml"), <<~YML)
      going_out:
        title: Hello
      ...
      klass = Class.new(Minitest::Test) do
        ...
        self.fixture_paths = [tmp_dir]
        self.use_transactional_tests = true
        self.ignore_transactions_dbnames = []
