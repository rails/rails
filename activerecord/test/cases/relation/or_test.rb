...
module ActiveRecord
  class OrTest < ActiveRecord::TestCase
    ...
    def test_or_with_out_of_range_value
      expected = Post.where("id = 1 or id = 2147483648").to_a
      assert_equal expected, Post.where(id: 1).or(Post.where(id: 2147483648)).to_a
    end
