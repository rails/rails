...
class ReflectionTest < ActiveRecord::TestCase
  ...
  def test_reflections_should_return_keys_as_symbols
    assert Category.reflections.keys.all? { |key| key.is_a? Symbol }, "Model.reflections is expected to return symbols for keys"
  end
