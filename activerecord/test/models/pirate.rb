class Pirate < ActiveRecord::Base
  ...
  has_one :ship #, inverse_of: :pirate # BUG: set inverse_of manually here to make test_accepts_nested_attributes_and_has_one_work_with_validate_presence_of pass
