    ...
    class PostgreSQLColumn < Column #:nodoc:
      ...
      private
        ...
        def self.extract_value_from_default(default)
          ...
          default.nil? && return nil 
          
          # to_s: to convert ruby type to pg type, then this variations are valid :default => true, :default => "true"
          # downcase: all ddl types are case insensitive so :default => "FALSE" should be valid as well
