  ...
  module ConnectionAdapters # :nodoc:
    module SchemaStatements
      ...
      def create_table(table_name, id: :primary_key, primary_key: nil, force: nil, **options, &block)
        ...
        if force
          statements << drop_table_sql(table_name, if_exists: true)
        end
        ...
        unless supports_indexes_in_create?
          td.indexes.each do |column_name, index_options|
            statements << schema_creation.accept(build_create_index_definition(table_name, column_name, **index_options, if_not_exists: td.if_not_exists))
          end
        end
      ...
      def drop_table(*table_names, **options)
        table_names.each do |table_name|
          schema_cache.clear_data_source_cache!(table_name.to_s)
          execute drop_table_sql(table_name, options[:if_exists])
        end
      end
      ...
      private
        ...
        def drop_table_sql(table_name, if_exists)
          "DROP TABLE#{' IF EXISTS' if if_exists} #{quote_table_name(table_name)}"
        end
