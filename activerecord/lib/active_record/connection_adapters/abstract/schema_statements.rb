...
module ActiveRecord
  module ConnectionAdapters # :nodoc:
    module SchemaStatements
      ...
      # [<tt>:on_delete</tt>]
      #   Action that happens <tt>ON DELETE</tt>. Valid values are +:nullify+, +:cascade+ and +:restrict+. Defaults to +:restrict+.
      # [<tt>:on_update</tt>]
      #   Action that happens <tt>ON UPDATE</tt>. Valid values are +:nullify+, +:cascade+ and +:restrict+. Defaults to +:restrict+.
