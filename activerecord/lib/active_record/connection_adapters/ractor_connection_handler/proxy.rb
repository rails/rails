    ...
    class RactorConnectionHandler # :nodoc:
      ...
      module Proxy # :nodoc:
        ...
        class ErrorResponse
          ...
          private
            # Arbitrary exceptions may carry unshareable or hidden state. Active Record
            # errors have known state we can copy; otherwise only stateless non-system
            # errors are safe to rebuild.
