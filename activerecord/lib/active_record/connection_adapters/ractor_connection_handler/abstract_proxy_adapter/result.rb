  ...
  module ConnectionAdapters
    class RactorConnectionHandler # :nodoc:
      class AbstractProxyAdapter < AbstractAdapter # :nodoc:
        ...
        # adapter read off the driver result on the main Ractor right after the
        # query: the warnings, and the generated id of an insert (e.g. `last_id`
        # for MySQL inserts without RETURNING).
