...
This is not reliable and will be removed in the future.
        ...
        class Timestamp < Type::Timestamp
          def type
            :datetime
          end
        ...
        class TypeMap < Type::TypeMapping
          def key?(oid)
            @mapping.key?(oid)
          end
          ...
          def fetch(ftype, fmod)
            ...
            @mapping.fetch(ftype) { |oid| yield oid, fmod }.call
          end
        end
        ...
        register_type 'int2', Type::Integer.new
        ...
        register_type 'date', Type::Date.new
        register_type 'time', Type::Time.new
