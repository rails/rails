      ...
      module SchemaStatements
        ...
        class SequenceReset # :nodoc:
          ...
          def reset
            ...
            @adapter.internal_batch_exec_query(reset_sqls, "SCHEMA")
          end
          ...
          private
            ...
            def backfill_sequences_with_primary_keys
              ...
              return unless tables_without_sequences.any?

              sql = primary_key_column_and_sequence_sql(tables_without_sequences)
              primary_key_column_and_sequences = @adapter.internal_exec_query(sql, "SCHEMA")
            ...
            def backfill_sequences_with_uuids
              ...
              uuid_column_and_sequences = @adapter.internal_exec_query(sql, "SCHEMA")
