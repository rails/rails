...
module ActiveRecord
  ...
  # <tt>read_store_attribute</tt> and <tt>write_store_attribute</tt> private
  ...
  module Store
    ...
    private
      # Read an attribute from the store. This method is private, and should not be called directly.
      #
      # ==== Parameters
      #
      ...
      # Write to an attribute in the store. This method is private, and should not be called directly.
      #
      # ==== Parameters
      #
      # * +store_attribute+ - The column name
