...
module ActiveRecord
  ...
  #
  #   class IrreversibleMigrationExample < ActiveRecord::Migration[5.2]
  #     def change
  ...
  #
  #  class ReversibleMigrationExample < ActiveRecord::Migration[5.2]
  #    def up
  #      create_table :distributors do |t|
  #        t.string :zipcode
  #      end
  ...
  #
  #   class AddSsl < ActiveRecord::Migration[5.2]
  #     def up
  ...
  #
  #   class AddSystemSettings < ActiveRecord::Migration[5.2]
  #     def up
  ...
  #
  #   class RemoveEmptyTags < ActiveRecord::Migration[5.2]
  #     def up
  ...
  #
  #   class RemoveUnnecessaryItemAttributes < ActiveRecord::Migration[5.2]
  #     def up
  ...
  #
  #   class MakeJoinUnique < ActiveRecord::Migration[5.2]
  #     def up
  ...
  #
  #   class AddPeopleSalary < ActiveRecord::Migration[5.2]
  #     def up
  ...
  # migration like this:
  #
  #   class TenderloveMigration < ActiveRecord::Migration[5.2]
  #     def change
  ...
  class Migration
    ...
    # on the way down.
    #
    #   class FixTLMigration < ActiveRecord::Migration[5.2]
    #     def change
    #       revert do
    #         create_table(:horses) do |t|
    #           t.text :content
    ...
    #
    #   class FixupTLMigration < ActiveRecord::Migration[5.2]
    #     def change
    ...
    #
    #    class SplitNameMigration < ActiveRecord::Migration[5.2]
    #      def change
