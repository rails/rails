...
module ActiveRecord
  module Assertions
    module QueryAssertions
      ...
      #
      def assert_queries_count(count = nil, include_schema: false, materialize_transactions: !include_schema, &block)
        ActiveRecord::Base.lease_connection.materialize_transactions if materialize_transactions
      ...
      #
      def assert_queries_match(match, count: nil, include_schema: false, materialize_transactions: !include_schema, &block)
        ActiveRecord::Base.lease_connection.materialize_transactions if materialize_transactions
