module ActiveRecord
  module NamedScope
    ...
    class Scope
      ...
      NON_DELEGATE_METHODS = %w(nil? send object_id class extend find size count sum average maximum minimum paginate first last empty? any? respond_to? try).to_set
      [].methods.each do |m|
