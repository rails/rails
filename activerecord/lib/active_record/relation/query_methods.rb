...
module ActiveRecord
  module QueryMethods
    ...
    #
    # ActiveRecord::Relation arguments generated by #includes or #preload are also acceptable:
    #
    #   User.includes(:address, friends: User.includes(:address, :followers))
    #
    # === Conditions
    #
    ...
    def includes(*args)
      coerce_relation_arguments!(args, :includes_values)
    ...
    # ActiveRecord::Relation arguments generated by #includes or #preload are also acceptable:
    #
    #   User.preload(:address, friends: User.includes(:address, :followers))
    #   # SELECT "users".* FROM "users"
    #   # SELECT "addresses".* FROM "addresses" WHERE "addresses"."id" IN (1,2,3,4,5)
    #   # SELECT "friends".* FROM "friends" WHERE "friends"."user_id" IN (1,2,3,4,5)
    #   # SELECT ...
    ...
    private
      ...
      def coerce_relation_arguments!(args, coercion)
        args.map! { |arg| arg.is_a?(Relation) ? arg.send(coercion) : arg }
      end
