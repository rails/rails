...
module ActiveRecord
  ...
  class Railtie < Rails::Railtie # :nodoc:
    ...
    guard_load_hooks(
      :active_record, :active_record_database_configurations, :active_record_encryption, :active_record_fixture_set,
      :active_record_fixtures, :active_record_mysql2adapter, :active_record_postgresqladapter, :active_record_sqlite3adapter,
