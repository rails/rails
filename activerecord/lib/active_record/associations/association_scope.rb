    ...
    class AssociationScope # :nodoc:
      ...
      private
        ...
        def last_chain_scope(scope, reflection, owner)
          primary_key = ActiveRecord::Key.for(reflection.join_query_constraints_primary_key)
          foreign_key = ActiveRecord::Key.for(reflection.join_query_constraints_foreign_key)
