...
module ActiveRecord
  module Encryption
    # An ActiveRecord::Type::Value that encrypts/decrypts strings of text.
    #
    # This is the central piece that connects the encryption system with +encrypts+ declarations in the
    # model classes. Whenever you declare an attribute as encrypted, it configures an +EncryptedAttributeType+
    # for that attribute.
    class EncryptedAttributeType < Type::Value
      ...
      #   (after decrypting). ActiveRecord::Type::String by default.
      def initialize(scheme:, cast_type: Type::String.new, previous_type: false, default: nil)
        super()
        @scheme = scheme
        @cast_type = cast_type
