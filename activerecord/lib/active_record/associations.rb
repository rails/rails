...
module ActiveRecord
  ...
  module Associations # :nodoc:
    ...
    private
      ...
      #
      # Note that the <tt>:through</tt> option will prevent an association's
      # inverse from being found automatically. Custom scopes and the
      # <tt>:foreign_key</tt> option can also prevent automatic detection in
      # some cases. See further details in the {Active Record Associations
      # guide}[https://guides.rubyonrails.org/association_basics.html#bi-directional-associations].
      #
