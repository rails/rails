  ...
  module Associations # :nodoc:
    ...
    private
      ...
      module ClassMethods
        ...
        #   * <tt>:nullify</tt> causes the foreign keys to be set to +NULL+. Polymorphic type will also be nullified on polymorphic associations. Callbacks are not executed.
        ...
        #   * <tt>:nullify</tt> causes the foreign key to be set to +NULL+. Polymorphic type column is also nullified on polymorphic associations. Callbacks are not executed.
