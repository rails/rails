...
module ActiveRecord
  ...
  module Associations # :nodoc:
    ...
    module ClassMethods
      ...
      #   has_and_belongs_to_many :active_projects, join_table: 'developers_projects', delete_sql: #   "DELETE FROM developers_projects WHERE active=1 AND developer_id = #{id} AND project_id = #{record.id}"
