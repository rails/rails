    ...
    class PostgreSQLDatabaseTasks # :nodoc:
      ...
      def create(master_established = false)
        ...
        if configuration['schema_search_path'].present?
          create_schemas(configuration['schema_search_path'])
        end
      ...
      def create_schemas(schema_search_path)
        schema_search_path.split(",").each do |schema|
          connection.create_schema schema.strip
        end
      end
