...
module ActiveRecord # :nodoc:
  module Normalization
    ...
    #
    # See ActiveModel::Normalization::ClassMethods#normalize_attribute.
    ...
    module ClassMethods
      ...
      #
      # See ActiveModel::Normalization::ClassMethods#normalizes.
      #
      ...
      #
      # See ActiveModel::Normalization::ClassMethods#normalize_value_for.
      #
      # ==== Examples
      #
      #   class User < ActiveRecord::Base
