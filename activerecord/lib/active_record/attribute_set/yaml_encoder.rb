module ActiveRecord
  class AttributeSet
    ...
    class YAMLEncoder
      ...
      #
      # Otherwise, #decode will build an attributes hash from coder using the
      # value under 'concise_attributes', while casting any nil types using
      # default_types. The resulting hash is used to return a new
