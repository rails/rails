...
class ShareableLoggerTest < ActiveSupport::TestCase
  setup do
    ...
    @tmp_dir = File.join(__dir__, "tmp", "shareable_logger_test")
  ...
  test "shareable logger writer is shareable" do
    ...
    writer = ActiveSupport::ShareableLogger::Writer.spawn(path)
  ...
  test "a dead consumer degrades to a no-op instead of hanging" do
    writer = ActiveSupport::ShareableLogger::Writer.spawn(NullDevice.new)
