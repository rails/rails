...
class AttributeMethodsTest < ActiveSupport::TestCase
  ...
  test "#define_attribute_methods defines alias attribute methods after undefining" do
    ...
    assert_equal("Active Support Topic", topic.aliased_title_to_be_redefined)
  ...
  test "#undefine_attribute_methods undefines alias attribute methods" do
    ...
    assert_equal("Active Support Topic", topic_class.new.subject_to_be_undefined)
    topic_class.undefine_attribute_methods
