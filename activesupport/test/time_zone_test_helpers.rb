...
module TimeZoneTestHelpers
  ...
  def with_tzinfo2_format(value)
    old_tzinfo2_format = ActiveSupport.use_tzinfo2_format
    ActiveSupport.use_tzinfo2_format = value
    yield
  ensure
    ActiveSupport.use_tzinfo2_format = old_tzinfo2_format
  end
end
