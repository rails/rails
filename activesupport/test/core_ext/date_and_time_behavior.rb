...
module DateAndTimeBehavior
  ...
  def test_end_of_days
    assert_equal date_time_int(2012,12,21,00,00,00,Rational(999999999, 1000)), date_time_init(2012,12,19,3,35,30).end_of_days
    assert_equal date_time_int(2012,12,21,00,00,00,Rational(999999999, 1000)), date_time_init(2013,1,1,3,35,30).end_of_days
  end    
