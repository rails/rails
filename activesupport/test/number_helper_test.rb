    ...
    class NumberHelperTest < ActiveSupport::TestCase
      ...
      def test_number_to_currency
        [@instance_with_helpers, TestClassWithClassNumberHelpers, ActiveSupport::NumberHelper].each do |number_helper|
          ...
          assert_equal("-$0.01", number_helper.number_to_currency(-0.001, round_mode: :up))
          assert_equal("$0.00", number_helper.number_to_currency(-0.009, round_mode: :down))
          assert_equal("$0.00", number_helper.number_to_currency(-0.005, round_mode: :half_even))
