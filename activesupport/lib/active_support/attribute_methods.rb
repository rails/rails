...
module ActiveSupport
  ...
  #   user = User.new
  #   user.id
  #   # => ActiveSupport::MissingAttributeError: missing attribute 'id' for User
  class MissingAttributeError < NoMethodError
  end

  # = Active \Support \Attribute \Methods
  #
  # Provides a way to add prefixes and suffixes to your methods as
  # well as handling the creation of ActiveRecord::Base - like
  # class methods such as +table_name+.
  #
  # The requirements to implement +ActiveSupport::AttributeMethods+ are to:
  #
  # * <tt>include ActiveSupport::AttributeMethods</tt> in your class.
  ...
  module AttributeMethods
    ...
    included do
      class_attribute :missing_attribute_error_class, instance_writer: false, default: ActiveSupport::MissingAttributeError
    ...
    # <tt>ActiveModel::AttributeAssignment#attributes=</tt>.
    #
    ...
    private
      ...
      def missing_attribute(attr_name, stack)
        raise missing_attribute_error_class, "missing attribute '#{attr_name}' for #{self.class}", stack
      end
      ...
      module AttrNames # :nodoc:
        ...
        def self.define_attribute_accessor_method(owner, attr_name, writer: false)
          ...
          if attr_name.ascii_only? && DEF_SAFE_NAME.match?(attr_name)
            ...
            attr_name_expr = "::ActiveSupport::AttributeMethods::AttrNames::#{const_name}"
