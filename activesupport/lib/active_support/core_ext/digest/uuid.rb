    ...
    def self.pack_uuid_namespace(namespace)
      if [DNS_NAMESPACE, OID_NAMESPACE, URL_NAMESPACE, X500_NAMESPACE].include?(namespace)
        ...
        ActiveSupport::Deprecation.warn <<~WARNING.squish
          Providing a UUID namespace that is not defined on Digest::UUID currently generates an incorrect UUID value according to RFC 4122. To enable the correct behavior, set the Rails.application.config.active_support.use_rfc4122_namespaced_uuids configuration option to true.
        WARNING
