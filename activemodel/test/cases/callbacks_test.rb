...
class CallbacksTest < ActiveModel::TestCase
  ...
  test "only selects which types of callbacks should be created" do
    refute ModelCallbacks.respond_to?(:before_initialize)
    refute ModelCallbacks.respond_to?(:around_initialize)
  ...
  test "only selects which types of callbacks should be created from an array list" do
    ...
    refute ModelCallbacks.respond_to?(:after_multiple)
  end

  test "no callbacks should be created" do
    refute ModelCallbacks.respond_to?(:before_empty)
    refute ModelCallbacks.respond_to?(:around_empty)
    refute ModelCallbacks.respond_to?(:after_empty)
  end
