  ...
  class Engine < Rails::Engine # :nodoc:
    ...
    initializer "active_storage.configs" do
      ...
      config.after_initialize do |app|
        ...
        if app.config.active_storage.md5_checksum_implementation
          ActiveStorage.md5_checksum_implementation = app.config.active_storage.md5_checksum_implementation
        end
      end
    end
