  ...
  module Transformers
    class ImageProcessingTransformer < Transformer
      private
        ...
        # Returns the transformation methods the backend accepts. Every backend has
        # to provide its own allowlist, since ImageMagick options and libvips
        # operations don't share the same vocabulary. All subclasses implement this
        # method.
        def supported_methods # :doc:
