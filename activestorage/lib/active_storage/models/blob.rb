...
require "active_storage/models/blobs/analyzable"
require "active_storage/models/blobs/identifiable"
require "active_storage/models/blobs/representable"
require "active_storage/models/blobs/servable"
...
module ActiveStorage
  module Models::Blob
    ...
    included do 
      ...
      has_many :attachments, autosave: false, class_name: attachment_class_name, foreign_key: :blob_id
      ...
      include Blobs::Analyzable
      include Blobs::Identifiable
      include Blobs::Representable
      include Blobs::Servable
      ...
      def url(expires_in: ActiveStorage.service_urls_expire_in, disposition: :inline, filename: nil, **options)
        service.url key, expires_in: expires_in, filename: ActiveStorage::Filename.wrap(filename || self.filename),
          content_type: content_type_for_serving, disposition: forced_disposition_for_serving || disposition, prefix: prefix, **options
      end

      # Returns a URL that can be used to directly upload a file for this blob on the service. This URL is intended to be
      # short-lived for security and only generated on-demand by the client-side JavaScript responsible for doing the uploading.
      def service_url_for_direct_upload(expires_in: ActiveStorage.service_urls_expire_in)
        service.url_for_direct_upload key, expires_in: expires_in, content_type: content_type, content_length: byte_size, checksum: checksum, custom_metadata: custom_metadata, prefix: prefix
      end
      ...
      def upload_without_unfurling(io) # :nodoc:
        service.upload key, io, checksum: checksum, prefix: prefix, **service_metadata
      end
      ...
      def mirror_later # :nodoc:
        service.mirror_later key, checksum: checksum, prefix: prefix if service.respond_to?(:mirror_later)
      end
