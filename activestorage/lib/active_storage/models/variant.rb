...
class ActiveStorage::Variant
  include ActiveStorage::Blobs::Servable
  ...
  def url(expires_in: ActiveStorage.service_urls_expire_in, disposition: :inline)
    service.url key, expires_in: expires_in, disposition: disposition, filename: filename, content_type: content_type, prefix: blob.prefix
  end
    ...
    def process
      blob.open do |input|
        variation.transform(input) do |output|
          service.upload(key, output, content_type: content_type, prefix: blob.prefix)
        end
      end
    end
end
