...
module ActiveStorage
  ...
  # - colorspace          : Ensure compatibility when performing transforations;
  #
  # Options below available only if vips/image magick where compiled against mozjpeg.
  ...
  #
  # Vips will ignore these options if mozjpeg is not available. ImageMagick will apply them automatically if it is.
