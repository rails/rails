...
module ActiveStorage::Blob::Representable
  ...
  def variant(transformations, name = nil)
    if variable?
      variant_class.new(self, ActiveStorage::Variation.wrap(transformations, name).default_to(default_variant_transformations))
    else
