...
class ActiveStorage::Blob < ActiveRecord::Base
  ...
  class << self
    ...
    def build_after_unfurling(io:, filename:, key: nil, content_type: nil, metadata: nil, service_name: nil, identify: true, record: nil) #:nodoc:
      new(key: key, filename: filename, content_type: content_type, metadata: metadata, service_name: service_name).tap do |blob|
        blob.unfurl(io, identify: identify)
      end
    end

    def create_after_unfurling!(io:, filename:, key: nil, content_type: nil, metadata: nil, service_name: nil, identify: true, record: nil) #:nodoc:
    ...
    # the signed ID.
    def create_before_direct_upload!(filename:, byte_size:, checksum:, key: nil, content_type: nil, metadata: nil, service_name: nil, record: nil)
