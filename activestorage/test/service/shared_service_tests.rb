...
module ActiveStorage::Service::SharedServiceTests
  ...
  included do
    ...
    test "uploading with integrity" do
      ...
      @service.upload(key, StringIO.new(data), checksum: ActiveStorage::Checksum.base64digest(data, ActiveStorage::Blob.service.checksum_algorithm))
    ...
    test "uploading without integrity" do
      ...
      assert_raises(ActiveStorage::IntegrityError) do
        @service.upload(key, StringIO.new(data), checksum: ActiveStorage::Checksum.base64digest("bad data", @service.checksum_algorithm))
      end
