...
if SERVICE_CONFIGURATIONS[:gcs]
  class ActiveStorage::Service::GCSServiceTest < ActiveSupport::TestCase
    ...
    test "direct upload" do
      ...
      checksum = ActiveStorage.md5_checksum_implementation.base64digest(data)
    ...
    test "upload with content_type and content_disposition" do
      ...
      @service.upload(key, StringIO.new(data), checksum: ActiveStorage.md5_checksum_implementation.base64digest(data), disposition: :attachment, filename: ActiveStorage::Filename.new("test.txt"), content_type: "text/plain")
    ...
    test "upload with content_type" do
      ...
      @service.upload(key, StringIO.new(data), checksum: ActiveStorage.md5_checksum_implementation.base64digest(data), content_type: "text/plain")
    ...
    test "update custom_metadata" do
      key      = SecureRandom.base58(24)
      data     = "Something else entirely!"
      @service.upload(key, StringIO.new(data), checksum: ActiveStorage.md5_checksum_implementation.base64digest(data), disposition: :attachment, filename: ActiveStorage::Filename.new("test.html"), content_type: "text/html", custom_metadata: { "foo" => "baz" })
