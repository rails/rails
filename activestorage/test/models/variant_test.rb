...
class ActiveStorage::VariantTest < ActiveSupport::TestCase
  ...
  test "resized variation of PSD blob" do
    process_variants_with :mini_magick do
      with_variable_content_types(%w(image/vnd.adobe.photoshop)) do
  ...
  test "resized variation of ICO blob" do
    process_variants_with :mini_magick do
      with_variable_content_types(%w(image/vnd.microsoft.icon)) do
  ...
  test "resized variation of TIFF blob" do
    process_variants_with :mini_magick do
      with_variable_content_types(%w(image/tiff)) do
  ...
  test "resized variation of BMP blob" do
    process_variants_with :mini_magick do
      with_variable_content_types(%w(image/bmp)) do
  ...
  test "resized variation of WEBP blob" do
    process_variants_with :mini_magick do
      with_variable_content_types(%w(image/webp)) do
        with_web_content_types(%w(image/webp)) do
  ...
  test "optimized variation of GIF blob" do
    with_variable_content_types(%w(image/gif)) do
  ...
  test "thumbnail variation of extensionless GIF blob processed with VIPS" do
    with_variable_content_types(%w(image/gif)) do
      with_web_content_types(%w(image/gif)) do
        process_variants_with :vips do
