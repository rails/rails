...
class ActiveStorage::BlobTest < ActiveSupport::TestCase
  ...
  test "create_and_upload sets byte size and checksum" do
    ...
    assert_equal ActiveStorage.md5_checksum_implementation.base64digest(data), blob.checksum
  end
  ...
  test "open without integrity" do
    create_blob(data: "Hello, world!").tap do |blob|
      blob.update! checksum: ActiveStorage.md5_checksum_implementation.base64digest("Goodbye, world!")
