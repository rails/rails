...
class ActiveStorage::AnimalsVariantTest < ActiveSupport::TestCase
  setup do
  ...
  test "resized variation of PSD blob" do
    blob = create_animals_file_blob(filename: "icon.psd", content_type: "image/vnd.adobe.photoshop")
  ...
  test "resized variation of ICO blob" do
    blob = create_animals_file_blob(filename: "favicon.ico", content_type: "image/vnd.microsoft.icon")
    variant = blob.variant(resize_to_limit: [20, 20]).processed
    assert_match(/icon\.png/, variant.url)
  ...
  test "resized variation of TIFF blob" do
    blob = create_animals_file_blob(filename: "racecar.tif")
  ...
  test "resized variation of BMP blob" do
    blob = create_animals_file_blob(filename: "colors.bmp", content_type: "image/bmp")
  ...
  test "resized variation of WEBP blob" do
    blob = create_animals_file_blob(filename: "valley.webp")
    variant = blob.variant(resize_to_limit: [50, 50]).processed
  ...
  test "optimized variation of GIF blob" do
    blob = create_animals_file_blob(filename: "image.gif", content_type: "image/gif")
  ...
  test "variation of invariable blob" do
    assert_raises ActiveStorage::InvariableError, match: /blob with ID=\d+ and content_type=application\/pdf/ do
      create_animals_file_blob(filename: "report.pdf", content_type: "application/pdf").variant(resize_to_limit: [100, 100])
    end
  end
  ...
  test "thumbnail variation of extensionless GIF blob processed with VIPS" do
    process_variants_with :vips do
      blob = ActiveStorage::AnimalsBlob.create_and_upload!(io: file_fixture("image.gif").open, filename: "image", content_type: "image/gif")
  ...
  test "passes content_type on upload" do
    blob = create_animals_file_blob(filename: "racecar.jpg", content_type: "image/jpeg")
