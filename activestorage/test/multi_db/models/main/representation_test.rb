...
class ActiveStorage::MainRepresentationTest < ActiveSupport::TestCase
  test "representing an image" do
    blob = create_main_file_blob
  ...
  test "representing a PDF" do
    blob = create_main_file_blob(filename: "report.pdf", content_type: "application/pdf")
  ...
  test "representing a PDF-based Illustrator file" do
    blob = create_main_file_blob(fixture: "report.pdf", filename: "file.ai", content_type: "application/illustrator")
    representation = blob.representation(resize_to_limit: [640, 280]).processed
