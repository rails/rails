...
module ApplicationTests
  class AssetsTest < ActiveSupport::TestCase
    ...
    test "assets routes have higher priority" do
      app_file "app/assets/images/rails-#{DUMMY_DIGEST}.digested.png", "notactuallyapng"
      app_file "app/assets/stylesheets/demo-#{DUMMY_DIGEST}.digested.css", "url('rails-#{DUMMY_DIGEST}.digested.png')"
      ...
      get "/assets/demo-#{DUMMY_DIGEST}.digested.css"
      assert_equal "url(\"/assets/rails-#{DUMMY_DIGEST}.digested.png\")", last_response.body.strip
    end
    ...
    test "precompile application.js and application.css and all other non JS/CSS files if manifest requests" do
      ...
      app_file "app/assets/javascripts/something.else.js", "alert();"
      app_file "app/assets/stylesheets/something.else.css", "body{}"
    ...
    test "precompile creates a manifest file with all the assets listed" do
      app_file "app/assets/images/rails.png", "notactuallyapng"
      remove_file "app/assets/stylesheets/application.css"
      app_file "app/assets/stylesheets/application.css", "url('rails.png')"
    ...
    test "does not stream session cookies back" do
      app_file "app/assets/javascripts/demo-#{DUMMY_DIGEST}.digested.js", "alert();"
      ...
      get "/assets/demo-#{DUMMY_DIGEST}.digested.js"
      assert_match "alert()", last_response.body
      assert_nil last_response.headers["Set-Cookie"]
    end

    test "files in any assets/ directories are not added to Propshaft" do
    ...
    test "asset URLs should use the request's protocol by default" do
      ...
      get "/posts", {}, { "HTTPS" => "off" }
      assert_match(%r{src="http://example.com/assets/application-([0-z]+).js}, last_response.body)
      get "/posts", {}, { "HTTPS" => "on" }
      assert_match(%r{src="https://example.com/assets/application-([0-z]+).js}, last_response.body)
    end

    test "asset URLs should be protocol-relative if no request is in scope" do
      app_with_assets_in_view
      app_file "app/assets/images/rails-#{DUMMY_DIGEST}.digested.png", "notreallyapng"
      app_file "app/views/posts/index.html.erb", "<%= image_path('rails-#{DUMMY_DIGEST}.digested.png') %>"
      ...
      get "/posts"
      assert_match("http://example.com/assets/rails-#{DUMMY_DIGEST}.digested.png", last_response.body)
    end
    ...
    test "asset paths should use RAILS_RELATIVE_URL_ROOT by default" do
      ...
      get "/posts"
      assert_match("/sub/uri/assets/rails-#{DUMMY_DIGEST}.digested.png", last_response.body)
    end
