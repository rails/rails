...
module ApplicationTests
  module RakeTests
    class RakeMigrationsTest < ActiveSupport::TestCase
      ...
      test "single db schema generation when dump_schema_after_migration and schema_dump are true" do
        add_to_config("config.active_record.dump_schema_after_migration = true")
      ...
      test "multi db schema generation when dump_schema_after_migration and schema_dump are true" do
        add_to_config("config.active_record.dump_schema_after_migration = true")
      ...
      test "single db schema generation when dump_schema_after_migration is true schema_dump is false" do
        add_to_config("config.active_record.dump_schema_after_migration = true")
      ...
      test "multi db schema generation when dump_schema_after_migration is true schema_dump is false" do
        add_to_config("config.active_record.dump_schema_after_migration = true")
      ...
      test "multi db schema generation when dump_schema_after_migration is false and schema_dump is true" do
        add_to_config("config.active_record.dump_schema_after_migration = false")
      ...
      test "multi db schema generation with schema dump only for primary" do
        add_to_config("config.active_record.dump_schema_after_migration = true")
      ...
      test "multi db schema generation with schema dump only for secondary" do
        add_to_config("config.active_record.dump_schema_after_migration = true")
