...
new_rails_conductor_inbound_email_source GET    /rails/conductor/action_mailbox/inbound_emails/sources/new(.:format)                              rails/conductor/action_mailbox/inbound_emails/sources#new
  ...
  test "rails routes with separated option" do
    app_file "config/routes.rb", <<-RUBY
      Rails.application.routes.draw do
        get '/cart', to: 'cart#show'
      end
    ...
    assert_equal <<~MESSAGE, run_routes_command([ "--separated" ])
                                  Prefix Verb   URI Pattern                                                                                       Controller#Action
                                    cart GET    /cart(.:format)                                                                                   cart#show
...
new_rails_conductor_inbound_email_source GET    /rails/conductor/action_mailbox/inbound_emails/sources/new(.:format)                              rails/conductor/action_mailbox/inbound_emails/sources#new
  ...
  test "rails routes with expanded and separated options" do
    output = rails "routes", [ "--expanded", "--separated" ], allow_failure: true
    assert_equal "WARNING: rails routes options cannot be both expanded (-E) and separated (-s).\n", output
