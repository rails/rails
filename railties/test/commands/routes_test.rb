...
class Rails::Command::RoutesTest < ActiveSupport::TestCase
  ...
  test "rails routes with expanded option" do
    ...
    assert_equal <<~MESSAGE, run_routes_command([ "--expanded" ])
      ...
      --[ Route 5 ]--------------
      Prefix            | rails_conductor_initializers
      Verb              | GET
      URI               | /rails/conductor/initializers(.:format)
      Controller#Action | rails/conductor/initializers#show
      --[ Route 6 ]--------------
      Prefix            | rails_conductor_middlewares
      Verb              | GET
      URI               | /rails/conductor/middlewares(.:format)
      Controller#Action | rails/conductor/middlewares#show
      --[ Route 7 ]--------------
