...
class ActionsTest < Rails::Generators::TestCase
  ...
  test "route should add route" do
    run_generator
    route_commands = ['get "foo"', 'get "ba"', 'get "baz"']
  ...
  def test_route_with_namespace_option_should_nest_route
    run_generator
  ...
  def test_route_with_namespace_option_array_should_deeply_nest_route
    run_generator
