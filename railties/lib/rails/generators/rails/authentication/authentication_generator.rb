    ...
    class AuthenticationGenerator < Base # :nodoc:
      ...
      def create_authentication_files
        ...
        if defined?(ActionMailer::Railtie)
          template "app/mailers/password_mailer.rb"

          template "app/views/password_mailer/reset.html.erb"
          template "app/views/password_mailer/reset.text.erb"

          template "test/mailers/previews/password_mailer_preview.rb"
        end
