...
STATS_DIRECTORIES = ActiveSupport::Deprecation::DeprecatedObjectProxy.new(
  ...
  "`STATS_DIRECTORIES` is deprecated and will be removed in Rails 8.1! Use `CodeStatistics.add_directory(label, path)` instead.",
  Rails.deprecator
)
...
task :stats do
  ...
  `bin/rake stats` as rake task has been deprecated and will be removed in Rails 8.1.
