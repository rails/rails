  ...
  class Application
    class Configuration < ::Rails::Engine::Configuration
      attr_accessor :allow_concurrency, :asset_host, :assume_ssl, :autoflush_log,
                    ...
                    :dom_testing_default_html_version, :yjit, :app_version
      ...
      def initialize(*)
        ...
        @yjit                                    = false
        @app_version                             = ActiveSupport::OrderedOptions.new
        @app_version.enabled                     = true
        @app_version.include_revision            = -> { Rails.env.local? }
        @app_version.add_headers                 = false
      end
