  ...
  class Application
    class Configuration < ::Rails::Engine::Configuration
      attr_accessor :allow_concurrency, :asset_host, :autoflush_log,
                    ...
                    :warn_on_no_content_security_policy, :require_master_key, :credentials,
                    :disable_sandbox, :add_autoload_paths_to_load_path, :rake_eager_load
      ...
      def initialize(*)
        ...
        @warn_on_no_content_security_policy      = false
