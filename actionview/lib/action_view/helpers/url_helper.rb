...
module ActionView
  ...
  module Helpers # :nodoc:
    ...
    module UrlHelper
      ...
      # if +condition+ is true, otherwise nothing is returned.
      #
      # ==== Examples
      #   <% mail_to_if(@current_user.admin?, "me@domain.com") %>
      #   # if user is admin...
      #   # # => <a href="mailto:me@domain.com">me@domain.com</a>
      #   # if user is not admin...
      #   # no email link is generated
      #
      #   <% mail_to_if(false, "me@domain.com") %>
      #   # If condition is false then email link is not generated.
      def mail_to_if(condition, email_address, name = nil, html_options = {}, &block)
        mail_to(email_address, name, html_options, &block) if condition
      end
