  ...
  module Helpers #:nodoc:
    ...
    module UrlHelper
      ...
      def phone_to(phone_number, name = nil, html_options = {}, &block)
        ...
        phone_chars = {"%2D" => "-", "%28" => "(", "%29" => ")"}
        encoded_phone_number = ERB::Util.url_encode(phone_number).gsub(/\w+/) {|p| phone_chars.fetch(p,p)}
        html_options["href"] = "tel:#{encoded_phone_number}"

        content_tag("a".freeze, name || phone_number, html_options, &block)
      end
