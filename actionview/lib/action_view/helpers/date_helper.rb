...
module ActionView
  module Helpers
    ...
    module DateHelper
      ...
      # To display months with a leading zero AND use month names, set the <tt>:use_two_digit_numbers</tt> and 
      # <tt>:add_month_numbers</tt> keys in +options+ to true.
      #
      ...
      #   select_month(Date.today, use_two_digit_numbers: true, add_month_numbers: true)
      #
      #   # Generates a select field for months that defaults to the current month that
    ...
    class DateTimeSelector #:nodoc:
      ...
      private
        ...
        #   month_name(1) => '01'
        #
        # If <tt>:use_two_digit_numbers</tt> and <tt>:add_month_numbers</tt> option is passed
        #  
        ...
        def month_name(number)
          if @options[:use_month_numbers]
            number
          elsif @options[:use_two_digit_numbers] && @options[:add_month_numbers]
            sprintf "%02d - %s", number, month_names[number]
