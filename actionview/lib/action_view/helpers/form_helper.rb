...
module ActionView
  module Helpers # :nodoc:
    ...
    class FormBuilder
      ...
      # field combination.
      #
      # Return the text-only label content generated by the <tt>FormBuilder</tt> for the given
      # attribute name.
      #
      #   form_for @post do |f|
      #     f.field_label :title
      #     # => "Title"
      #
      #     f.field_label :published, value: true
      #     # => "Published"
      #
      #     f.field_label :published, value: false
      #     # => "Draft"
      #   end
      #
      def field_label(method, value: nil)
        object_name = @options.fetch(:as) { @object_name }

        @template.field_label(object_name, method, object: @object, value: value)
      end
