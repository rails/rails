  ...
  class Template
    ...
    def refresh(view)
      ...
      lookup.disable_cache do
        lookup.find_template(template_name, [ virtual_path_pieces.join('/') ], partial?, @locals)
      end
    end

    def partial?
      @partial||=!!template_name.sub!(/^_/, "")
    end


    def template_name
      @template_name||= virtual_path_pieces.pop
    end

    def virtual_path_pieces
