...
class UrlHelperTest < ActiveSupport::TestCase
  ...
  def test_button_to_with_custom_autenticity_token
    ...
    assert_dom_equal(
      %{<form action="http://www.example.com" class="button_to" method="post"><button type="submit">Hello</button><input type="hidden" name="form_token" value="custom_secret" /></form>},
