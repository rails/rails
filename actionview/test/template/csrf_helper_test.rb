...
class CsrfHelperTest < ActiveSupport::TestCase
  ...
  def test_csrf_meta_tags_with_request_forgery_protection
    ...
    assert_dom_equal <<~DOM.chomp, csrf_meta_tags
      <meta name="csrf-param" content="form_token" class="notranslate" translate="no" data-wg-notranslate="true" />
      <meta name="csrf-token" content="secret" class="notranslate" translate="no" data-wg-notranslate="true" />
    DOM
  ensure
