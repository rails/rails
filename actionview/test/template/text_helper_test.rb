...
class TextHelperTest < ActionView::TestCase
  ...
  def test_concat
    self.output_buffer = String.new('foo')
  ...
  def test_truncate_multibyte
    assert_equal String.new("\354\225\204\353\246\254\353\236\221 \354\225\204\353\246\254 ...").force_encoding(Encoding::UTF_8),
      truncate(String.new("\354\225\204\353\246\254\353\236\221 \354\225\204\353\246\254 \354\225\204\353\235\274\353\246\254\354\230\244").force_encoding(Encoding::UTF_8), :length => 10)
  end
  ...
  def test_excerpt_with_utf8
    assert_equal(String.new("...\357\254\203ciency could not be...").force_encoding(Encoding::UTF_8), excerpt(String.new("That's why e\357\254\203ciency could not be helped").force_encoding(Encoding::UTF_8), 'could', :radius => 8))
  end
