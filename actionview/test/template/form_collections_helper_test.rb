...
class FormCollectionsHelperTest < ActionView::TestCase
  def assert_no_select(selector, value = nil)
    assert_dom(selector, text: value, count: 0)
  end
  ...
  test "collection radio accepts a collection and generates inputs from value method" do
    ...
    assert_dom "input[type=radio][value=true]#user_active_true"
    assert_dom "input[type=radio][value=false]#user_active_false"
  end

  test "collection radio accepts a collection and generates inputs from label method" do
    with_collection_radio_buttons :user, :active, [true, false], :to_s, :to_s

    assert_dom "label[for=user_active_true]", "true"
    assert_dom "label[for=user_active_false]", "false"
  end

  test "collection radio handles camelized collection values for labels correctly" do
    with_collection_radio_buttons :user, :active, ["Yes", "No"], :to_s, :to_s

    assert_dom "label[for=user_active_yes]", "Yes"
    assert_dom "label[for=user_active_no]", "No"
  end
  ...
  test "collection radio generates labels for non-English values correctly" do
    ...
    assert_dom "input[type=radio]#user_title_господин"
    assert_dom "label[for=user_title_господин]", "Господин"
  end

  test "collection radio should sanitize collection values for labels correctly" do
    with_collection_radio_buttons :user, :name, ["$0.99", "$1.99"], :to_s, :to_s
    assert_dom "label[for=user_name_0_99]", "$0.99"
    assert_dom "label[for=user_name_1_99]", "$1.99"
  end
  ...
  test "collection radio correctly builds unique DOM IDs for float values" do
    ...
    assert_dom "label[for=user_name_1_0]", "1.0"
    assert_dom "label[for=user_name_10]", "10"
    assert_dom 'input#user_name_1_0[type=radio][value="1.0"]'
    assert_dom 'input#user_name_10[type=radio][value="10"]'
  end

  test "collection radio accepts checked item" do
    with_collection_radio_buttons :user, :active, [[1, true], [0, false]], :last, :first, checked: true

    assert_dom "input[type=radio][value=true][checked=checked]"
  ...
  test "collection radio accepts multiple disabled items" do
    ...
    assert_dom "input[type=radio][value=true][disabled=disabled]"
    assert_dom "input[type=radio][value=false][disabled=disabled]"
  ...
  test "collection radio accepts multiple readonly items" do
    ...
    assert_dom "input[type=radio][value=true][readonly=readonly]"
    assert_dom "input[type=radio][value=false][readonly=readonly]"
  ...
  test "collection radio accepts html options as input" do
    ...
    assert_dom "input[type=radio][value=true].special-radio#user_active_true"
    assert_dom "input[type=radio][value=false].special-radio#user_active_false"
  end
  ...
  test "collection radio accepts html options as the last element of array" do
    ...
    assert_dom "input[type=radio][value=true].foo#user_active_true"
    assert_dom "input[type=radio][value=false].bar#user_active_false"
  end
  ...
  test "collection radio sets the label class defined inside the block" do
    ...
    assert_dom "label.collection_radio_buttons[for=user_active_true]"
    assert_dom "label.collection_radio_buttons[for=user_active_false]"
  end
  ...
  test "collection radio does not wrap input inside the label" do
    ...
    assert_dom "input[type=radio] + label"
  ...
  test "collection radio accepts a block to render the label as radio button wrapper" do
    ...
    assert_dom "label[for=user_active_true] > input#user_active_true[type=radio]"
    assert_dom "label[for=user_active_false] > input#user_active_false[type=radio]"
  end
  ...
  test "collection radio with block helpers accept extra html options" do
    ...
    assert_dom "label.radio_button[for=user_active_true] + input#user_active_true.radio_button[type=radio]"
    assert_dom "label.radio_button[for=user_active_false] + input#user_active_false.radio_button[type=radio]"
  end
  ...
  test "collection radio with block helpers allows access to current text and value" do
    ...
    assert_dom "label[for=user_active_true][data-value=true]", "true" do
      assert_dom "input#user_active_true[type=radio]"
    end
    assert_dom "label[for=user_active_false][data-value=false]", "false" do
      assert_dom "input#user_active_false[type=radio]"
    end
  end
  ...
  test "collection radio with block helpers allows access to the current object item in the collection to access extra properties" do
    ...
    assert_dom "label.true[for=user_active_true]", "true" do
      assert_dom "input#user_active_true[type=radio]"
    end
    assert_dom "label.false[for=user_active_false]", "false" do
      assert_dom "input#user_active_false[type=radio]"
    end
  end
  ...
  test "collection radio buttons with fields for" do
    ...
    assert_dom 'input#post_category_id_1[type=radio][value="1"]'
    assert_dom 'input#post_category_id_2[type=radio][value="2"]'

    assert_dom "label[for=post_category_id_1]", "Category 1"
    assert_dom "label[for=post_category_id_2]", "Category 2"
  end
  ...
  test "collection radio accepts checked item which has a value of false" do
    ...
    assert_dom "input[type=radio][value=false][checked=checked]"
  end
  ...
  test "collection radio buttons generates only one hidden field for the entire collection, to ensure something will be sent back to the server when posting an empty collection" do
    ...
    assert_dom "input[type=hidden][name='user[category_ids]'][value='']", count: 1
  end
  ...
  test "collection radio buttons generates a hidden field using the given :name in :html_options" do
    ...
    assert_dom "input[type=hidden][name='user[other_category_ids]'][value='']", count: 1
  end
  ...
  test "collection radio buttons generates a hidden field with index if it was provided" do
    ...
    assert_dom "input[type=hidden][name='user[322][category_ids]'][value='']", count: 1
  end
  ...
  test "collection radio buttons does not generate a hidden field if include_hidden option is false" do
    ...
    assert_dom "input[type=hidden][name='user[category_ids]'][value='']", count: 0
  end
  ...
  test "collection check boxes accepts a collection and generate a series of checkboxes for value method" do
    ...
    assert_dom 'input#user_category_ids_1[type=checkbox][value="1"]'
    assert_dom 'input#user_category_ids_2[type=checkbox][value="2"]'
  end
  ...
  test "collection check boxes accepts a collection and generate a series of checkboxes with labels for label method" do
    ...
    assert_dom "label[for=user_category_ids_1]", "Category 1"
    assert_dom "label[for=user_category_ids_2]", "Category 2"
  end
  ...
  test "collection check boxes correctly builds unique DOM IDs for float values" do
    ...
    assert_dom "label[for=user_name_1_0]", "1.0"
    assert_dom "label[for=user_name_10]", "10"
    assert_dom 'input#user_name_1_0[type=checkbox][value="1.0"]'
    assert_dom 'input#user_name_10[type=checkbox][value="10"]'
  end
  ...
  test "collection check boxes generates labels for non-English values correctly" do
    ...
    assert_dom "input[type=checkbox]#user_title_господин"
    assert_dom "label[for=user_title_господин]", "Господин"
  end
  ...
  test "collection check boxes accepts html options as the last element of array" do
    ...
    assert_dom 'input[type=checkbox][value="1"].foo'
    assert_dom 'input[type=checkbox][value="2"].bar'
  end
  ...
  test "collection check boxes propagates input id to the label for attribute" do
    ...
    assert_dom "label[for=foo]"
    assert_dom "label[for=bar]"
  end
  ...
  test "collection check boxes sets the label class defined inside the block" do
    ...
    assert_dom "label.collection_check_boxes[for=user_active_category_1]"
    assert_dom "label.collection_check_boxes[for=user_active_category_2]"
  end
  ...
  test "collection check boxes accepts selected values as :checked option" do
    ...
    assert_dom 'input[type=checkbox][value="1"][checked=checked]'
    assert_dom 'input[type=checkbox][value="3"][checked=checked]'
  ...
  test "collection check boxes accepts multiple disabled items" do
    ...
    assert_dom 'input[type=checkbox][value="1"][disabled=disabled]'
    assert_dom 'input[type=checkbox][value="3"][disabled=disabled]'
  ...
  test "collection check boxes accepts multiple readonly items" do
    ...
    assert_dom 'input[type=checkbox][value="1"][readonly=readonly]'
    assert_dom 'input[type=checkbox][value="3"][readonly=readonly]'
  ...
  test "collection check boxes accepts html options" do
    ...
    assert_dom 'input.check[type=checkbox][value="1"]'
    assert_dom 'input.check[type=checkbox][value="2"]'
  end
  ...
  test "collection check boxes with fields for" do
    ...
    assert_dom 'input#post_category_ids_1[type=checkbox][value="1"]'
    assert_dom 'input#post_category_ids_2[type=checkbox][value="2"]'

    assert_dom "label[for=post_category_ids_1]", "Category 1"
    assert_dom "label[for=post_category_ids_2]", "Category 2"
  end

  test "collection check boxes does not wrap input inside the label" do
    with_collection_check_boxes :user, :active, [true, false], :to_s, :to_s

    assert_dom "input[type=checkbox] + label"
    assert_no_select "label input"
  end
  ...
  test "collection check boxes accepts a block to render the label as check box wrapper" do
    ...
    assert_dom "label[for=user_active_true] > input#user_active_true[type=checkbox]"
    assert_dom "label[for=user_active_false] > input#user_active_false[type=checkbox]"
  end
  ...
  test "collection check boxes with block helpers accept extra html options" do
    ...
    assert_dom "label.check_box[for=user_active_true] + input#user_active_true.check_box[type=checkbox]"
    assert_dom "label.check_box[for=user_active_false] + input#user_active_false.check_box[type=checkbox]"
  end
  ...
  test "collection check boxes with block helpers allows access to current text and value" do
    ...
    assert_dom "label[for=user_active_true][data-value=true]", "true" do
      assert_dom "input#user_active_true[type=checkbox]"
    end
    assert_dom "label[for=user_active_false][data-value=false]", "false" do
      assert_dom "input#user_active_false[type=checkbox]"
    end
  end
