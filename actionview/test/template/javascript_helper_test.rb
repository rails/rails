...
class JavaScriptHelperTest < ActionView::TestCase
  ...
  def test_escape_javascript
    ...
    assert_equal %(unicode &#x2028; newline), escape_javascript(String.new(%(unicode \342\200\250 newline)).force_encoding(Encoding::UTF_8).encode!)
    assert_equal %(unicode &#x2029; newline), escape_javascript(String.new(%(unicode \342\200\251 newline)).force_encoding(Encoding::UTF_8).encode!)
