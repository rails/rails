...
class LookupContextTest < ActiveSupport::TestCase
  ...
  test "normalizes details on initialization" do
    assert_equal ActiveSupport::Mime::SET.to_a, @lookup_context.formats
  ...
  test "handles explicitly defined */* formats fallback to :js" do
    @lookup_context.formats = [:js, ActiveSupport::Mime::ALL]
    assert_equal [:js, *ActiveSupport::Mime::SET.symbols], @lookup_context.formats
  end
