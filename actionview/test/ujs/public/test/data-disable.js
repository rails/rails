...
QUnit.test('form input field with "data-disable" attribute', function(assert) {
  ...
  var form = $('#qunit-fixture form[data-remote]'), input = form.find('input[type=text]')
...
QUnit.test('form button with "data-disable" attribute', function(assert) {
  ...
  var form = $('#qunit-fixture form[data-remote]'), button = $('<button data-disable name="submit2">Submit</button>')
  form.append(button)
...
QUnit.test('form[data-remote] textarea[data-disable] attribute', function(assert) {
  ...
  var form = $('#qunit-fixture form[data-remote]'),
