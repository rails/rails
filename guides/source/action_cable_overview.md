...
```js
// app/assets/javascript/channels/consumer.js
...
```js
// app/assets/javascript/channels/chat_channel.js
import consumer from "./consumer"

consumer.subscriptions.create({ channel: "ChatChannel", room: "Best Room" })

// app/assets/javascript/channels/appearance_channel.js
import consumer from "./consumer"
...
```js
// app/assets/javascript/channels/web_notifications_channel.js
