...
The best way to read this guide is to follow it step by step. As all steps are 
important/non-optional. To run this example application no additional code or 
steps are needed.
