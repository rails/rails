...
As noted above, for collections with instances of different models, Rails chooses the partial appropriate to the model. The counter variable increments for each partial, regardless of the class of the model being rendered.
