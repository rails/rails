...
This guide provides steps to be followed when you upgrade your applications from Rails 5.0 to Rails 5.1. These steps are also available in individual release guides.
