...
To localize store and update _content_ in your application (e.g. translate blog posts), see the [Storing translated content](#storing-translated-content) section.
