...
TIP: The jQuery way looks neat at first, but as your app grows you start losing control of where that code was and what exactly it did:
...
NOTE: Handling JSON seems fast at first, we'll cover that here too

h4. Programmer-fast way
