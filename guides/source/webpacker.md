...
The below information mainly applies to the unreleased v6, which has been released as the [gem 'shakapacker'](https://github.com/shakacode/shakapacker). Webpacker development continues in that repo.
