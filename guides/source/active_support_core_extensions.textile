...
The method +multiple_of?+ tests whether a numeric is a multiple of the argument:

<ruby>
2.multiple_of?(1) # => true
1.multiple_of?(2) # => false
(2.4).multiple_of(1.2) # => true
(3.8).multiple_of(1.2) # => false
</ruby>

NOTE: Defined in +active_support/core_ext/numeric/multiple.rb+.
