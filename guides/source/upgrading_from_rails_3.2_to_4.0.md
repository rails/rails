...
This guide provides steps to be followed when you upgrade your applications from Rails 3.2 to Rails 4.0. These steps are also available in individual release guides.
