...
TIP: The `--pretend` option can be handy to check the difference in files generated by related generators before actually running them, by the `model` vs. `resource` generator, for example.
