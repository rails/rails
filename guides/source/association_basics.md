...
* `:nullify` causes the foreign key to be set to `NULL`. On polymorphic associations both the foreign key and foreign type column will be set to `NULL`. Callbacks are not executed. 
