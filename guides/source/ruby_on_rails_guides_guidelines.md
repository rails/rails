...
Sometimes the guides highlight a specific paragraph to give it more attention.
Prefix the paragraph with `NOTE:`, `TIP:` or `WARNING:` to highlight it:

```markdown
NOTE: Use `NOTE`, `TIP` or `WARNING` to highlight a paragraph.
```

This will wrap the paragraph in a special container:
...
Reading it will aid/expand your understanding of that subject/context, or
...
A `TIP`, on the other hand, is just an additional bit of information regarding
the subject, but not necessarily relevant to the understanding. It can point
you to another guide or website:
