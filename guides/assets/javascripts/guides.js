(function() {
  ...
  document.addEventListener("turbo:load", function() {
    ...
    var guides = document.getElementById(guidesMenuButton.getAttribute('aria-controls'));

    var toggleGuidesMenu = function () {
      var nextExpanded = guidesMenuButton.getAttribute('aria-expanded') === 'false'

      guides.classList.toggle("visible");
      guidesMenuButton.setAttribute('aria-expanded', nextExpanded ? 'true' : 'false')

      var focusElement = nextExpanded ? guides.querySelector('a') : guidesMenuButton
      focusElement.focus();
    }
    ...
    document.addEventListener('click', function (e) {
      ...
      if (e.target instanceof Element) {
        if (!e.target.closest('#' + guidesMenuButton.getAttribute('aria-controls'))) {
          toggleGuidesMenu();
        }
      }
    });
    ...
    document.addEventListener("keyup", function(e) {
      if (e.key === "Escape" && guidesMenuButton.getAttribute('aria-expanded') === 'true') {
        toggleGuidesMenu();
      }
    });
    ...
    var moreInfoLinks = document.getElementById(moreInfoButton.getAttribute('aria-controls'));
    ...
    document.addEventListener("keyup", function(e) {
      if (e.key === "Escape" && moreInfoButton.getAttribute('aria-expanded') === 'true') {
        toggleMoreInfoContent();
      }
    });
