...
module ActionCable
  module Channel
    ...
    #
    # NOTE: the +after_subscribe+ callback is triggered whenever
    # the +subscribed+ method is called, even if subscription was rejected
    # with the +reject+ method.
    # To trigger +after_subscribe+ only on successful subscriptions,
