      ...
      private
        ...
        def subscribe_to_internal_channel
          if connection_identifier.present?
            ...
            server.executor.post { pubsub.subscribe(internal_channel, callback) }
        ...
        def unsubscribe_from_internal_channel
          if @_internal_subscriptions.present?
            @_internal_subscriptions.each { |channel, callback| server.executor.post { pubsub.unsubscribe(channel, callback) } }
          end
        end
